		...
		<div >
				...
				<table class="form">
					...
					<tr>
						...
						<td>
							<input name="account"  class="field"><b class="em">*</b>
						</td>
					</tr>
					<tr>
						<td class="ar">
						...
						<td>
						<input name="name"  class="field"><b class="em">*</b>
						</td>
					</tr>
					<tr>
						<td class="ar">
						...
						<td>
						<textarea name="remark" rows="3" cols="16"></textarea>
						</td>
					</tr>
					</tbody>
					<tfoot>
					<tr>
						<td colspan="2" >
							<button type="button" onclick="userFormSubmit(this.form)" >确定</button>
